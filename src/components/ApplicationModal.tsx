        ...
        {submissionSuccess ? (
          <div className="text-center py-8 space-y-4">
            ...
            <p className="text-neutral-400 text-sm max-w-sm mx-auto">
              Your pre-approval request has been assigned reference:
            </p>
            ...
            <p className="text-xs text-neutral-500">
              A Speed Leasing financial concierge will reach out to verify your dossier.
            </p>
            <button
              onClick={onClose}
          ...
          <div>
            ...
            <div className="my-4 p-3 bg-neutral-950 rounded-xl border border-neutral-800/80 grid grid-cols-3 text-center text-xs">
              ...
              <div>
                <span className="text-neutral-500">Annual Allowance</span>
